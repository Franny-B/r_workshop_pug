...
```{r}
v_num <- c(1,2,3,4)
v_char <- c("eins", 'zwei', 'drei', 'vier')
v_logi <- c(TRUE,TRUE,FALSE,FALSE)
...
```{r}
V_numChar <- c(v_num, v_char)
v_charLogi <- c(v_char, v_logi)
v_numLogi <- c(v_num, v_logi)
v_numcharlogi <- c(v_num, v_char, v_logi)
```
